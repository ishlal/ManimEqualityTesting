...
class Scene31(Scene):
    def construct(self):
        title = Text("Case 2", font_size=100, color=PURPLE_B)
        subtitle = Text("Alice and Bob have different passwords", font_size=60, color=TEAL_B).next_to(title, DOWN)
        ...
        target_group_square_b_mod_p = Square(color=TEAL_E, fill_opacity=0.5).scale(1.5)
        ...
        square_b_mod_p_copy = Square(color=TEAL_E, fill_opacity=0.5).scale(0.7)
        ...
        text_equal = MathTex("\stackrel{?}{=}").scale(1.5)
        ...
        text_before = MathTex(r"\text{Before}")
        text_before.move_to(rect_mod_p.get_edge_center(UP) + UP*0.5)
        self.play(FadeIn(text_before))
        ...
        self.play(
            FadeOut(text_a_result_copy),
            FadeOut(text_b_result_copy),
            FadeOut(arrow_a_result),
            FadeOut(arrow_b_result),
            FadeOut(text_equals_copy),
            FadeOut(text_equal_2),
            FadeOut(text_before),
            FadeOut(arrow_a),
            FadeOut(arrow_b),
        )
        ...
        text_now = MathTex(r"\text{Now}")
        text_now.move_to(rect_mod_p.get_edge_center(UP) + UP*0.5 + LEFT*0.5)
        self.play(FadeIn(text_now))
        self.wait(0.3)
        text_hopefully = MathTex(r"\text{Hopefully}")
        text_hopefully.next_to(text_now, RIGHT)
        self.play(FadeIn(text_hopefully))
        ...
        text_a_transform = MathTex("17").scale(1.2)
        text_b_transform = MathTex("19").scale(1.2)
        text_rect_transform = MathTex(r"\bmod \;2 \text{ operation}")

        text_a_transform.move_to(text_a.get_center())
        text_b_transform.move_to(text_b.get_center())
        text_rect_transform.move_to(rect_mod_p.get_center())
        self.play(Transform(text_a, text_a_transform))
        self.wait(0.5)
        self.play(Transform(text_b, text_b_transform))
        self.wait(0.5)
        self.play(Transform(text_rect_mod_p, text_rect_transform))
        self.wait(0.5)

        text_equal_num = MathTex(r"\neq", color=RED).scale(1.5)
        # move text_equal_2 in between text_a and text_b
        text_equal_num.move_to((text_a.get_center() + text_b.get_center())/2)
        self.play(FadeIn(text_equal_num))



        self.play(text_a_transform.animate.move_to(rect_mod_p.get_edge_center(LEFT)),
                    text_b_transform.animate.move_to(rect_mod_p.get_edge_center(LEFT)))
        self.play(FadeOut(text_a_transform), FadeOut(text_b_transform))
        self.wait(0.5)

        text_a_result = MathTex(r"1").scale(1.2)
        text_b_result = MathTex(r"1").scale(1.2)
        # move text_a_result and text_b_result to right side of rectangle
        ...
        text_equals_copy = MathTex("=", color=GREEN).scale(1.5)
        text_equals_copy.move_to((text_a_result_copy.get_center() + text_b_result_copy.get_center())/2)
        self.play(FadeIn(text_equals_copy))
        self.wait(4)
